    ...
    return (
        <>
            <Container className='mt-4 text-left'>
                ...
                <Button className="button2" onClick={() => setModifyIsActive(true)} variant="outline-secondary">Modify/delete an existing survey</Button>{' '}
            </Container>
                    ...
                    <Col xs={7} className='text-left mx-4 resultsSheet'>
                        ...
                        <Stack gap={3}>
                            ...
                            {newSurvey.questions.map(question =>
                                <div key={question.questionId} style={{ borderStyle: "solid", borderColor: "#227174", borderWidth: "2px", padding: "10px" }}>
                                    <>
                                    ...
                                    {(question.questionType === "dropdown" || question.questionType === "multiple-choice") ?
                                        <>
                                            ...
                                            {addOptionIsActive ?
                                                <AddNewOption createNewOption={createNewOption} />
                            ...
                            <Button className="button" onClick={() => handleSave(newSurvey)} type="submit">Submit survey</Button>
                        </Stack>
                    </Col>
                </Row >
            </Container >
